...
def show():
    ...
    listheader = ['Name', 'Email', 'Address', 'Telephone']
    ...
    tree.heading(1, text='Email', anchor=NW)
    tree.heading(2, text='Address', anchor=NW)
    tree.heading(3, text='Telephone', anchor=NW)
...
def insert():
    ...
    if Name == '' or Email == '' or Address == '' or Telephone == '':
...
def to_update():
    try:
        ...
        def confirm():
            ...
            data = [new_telephone, new_name, new_email, new_address, new_telephone]
...
app_name = Label(frame_up, text="Address Book System", height = 1, font=('Verdana 17 bold'), bg = co2, fg = co0)
